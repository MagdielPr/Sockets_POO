...
public class Server {
    ...
    private static final String COMANDOS_FILE_PATH = "\"C:\\Users\\lucas\\eclipse-workspace\\Sockets\\comandos.json\"";
    ...
    private void carregarComandos() {
        try (Reader reader = new FileReader(COMANDOS_FILE_PATH)) {
            Type listType = new TypeToken<List<String>>(){}.getType();
            comandos = gson.fromJson(reader, listType);
            if (comandos == null) {
                comandos = new ArrayList<>();
            }
        } catch (IOException e) {
            System.out.println("Erro ao carregar comandos do arquivo JSON: " + e.getMessage());
            comandos = new ArrayList<>();
        }
    }

    private void salvarComandos() {
        try (Writer writer = new FileWriter(COMANDOS_FILE_PATH)) {
            gson.toJson(comandos, writer);
        } catch (IOException e) {
            System.out.println("Erro ao salvar comandos no arquivo JSON: " + e.getMessage());
        }
    }
